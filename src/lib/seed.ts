  ...
  try {
    ...
    const coursesData = [
      ...
      },
      {
        ...
        description: "Algorithms and Computer Systems",
        prerequisites: null,
        credits: 5,
        parity: "odd",
        type: "dcc",
      ...
      // Semestre 2
      {
        ...
        prerequisites: "MAT1203 o IMT2210 o (IIC1001 y MAT1207)",
        credits: 10,
        parity: "both",
        type: "dcc",
      },
      ...
      },
      {
        ...
        prerequisites: "MAT1000 o MAT1107",
        credits: 10,
        parity: "both",
        type: "fmat",
      },
      ...
      // Semestre 3
      {
        ...
        prerequisites:
          "(IIC1253 y IIC2233) o ICS2122 o IRB2002 o IDI2025 o IBM2123 o IIC2154",
        credits: 10,
        parity: "both",
        type: "dcc",
      },
      {
        ...
        prerequisites:
          "IIC2233 o (IIC1222 y IIC2252) o ICS2122 o IRB2002 o IDI2025 o IBM2123",
        credits: 10,
        parity: "both",
        type: "dcc",
      },
      ...
      },
      {
        ...
        prerequisites: "MAT1600 o MAT1207",
        credits: 10,
        parity: "both",
        type: "fmat",
      },
      ...
      // Semestre 4
      {
        ...
        prerequisites:
          "(EYP1015 y MAT1135) o (EYP1015 y MAT1630) o (IMT2220 y IMT2230) o (IIC1253 y MAT1620)",
        credits: 10,
        parity: "both",
        type: "fmat",
      },
      {
        ...
        prerequisites: "IIC2413 o ICS2122 o IRB2002 o IDI2025 o IBM2123",
        credits: 10,
        parity: "both",
        type: "dcc",
      },
      {
        ...
        description: "Automata and Compilers",
        prerequisites: "(IIC1253 o IIC2252) y (IIC2133 o IIC2132)",
        credits: 10,
        parity: "both",
        type: "major",
      },
      ...
      // Semestre 5
      {
        ...
        prerequisites: "(IIC2343 o IIC2342) y (IIC2224 o IIC2223)",
        credits: 10,
        parity: "odd",
        type: "major",
      },
      {
        ...
        prerequisites: "IIC1253 o IIC2252",
        credits: 10,
        parity: "odd",
        type: "major",
      },
      {
        ...
        prerequisites: "IIC2143 o ICS2122 o IRB2002 o IDI2025 o IBM2123",
        credits: 10,
        parity: "both",
        type: "major",
      },
      ...
      // Semestre 6
      {
        ...
        prerequisites:
          "(EYP1113 y IIC2233) o (EYP1025 y IIC2233) o (AST0212 y IIC2233) o ICS2122 o IRB2002 o IDI2025 o IBM2123",
        credits: 10,
        parity: "both",
        type: "major",
      },
      {
        ...
        prerequisites:
          "IIC2133 o (IIC2132 y IIC2212) o ICS2122 o IRB2002 o IDI2025 o IBM2123",
        credits: 10,
        parity: "both",
        type: "major",
      },
      {
        ...
        prerequisites: "(IIC2333 o IIC2512) o (IIC2133 o IIC2132)",
        credits: 10,
        parity: "both",
        type: "major",
      },
      {
        ...
        description: "Ethics for Computer Science",
        prerequisites: "(IIC2143 o IIC2142) y IIC2513",
        credits: 10,
        parity: "both",
        type: "eti",
      },
      ...
      // Semestre 7
      {
        ...
        prerequisites:
          "IIC2333 o (IIC1222 y IIC2342) o ICS2122 o IRB2002 o IDI2025 o IBM2123 o IIC2154",
        credits: 10,
        parity: "both",
        type: "major",
      },
      ...
      // Semestre 8
      {
        ...
        description: "Innovation and Computing Project",
        prerequisites: "ETI1001 y IIC2182 y IIC2531",
        credits: 10,
        parity: "even",
        type: "dcc",
      },
      ...
      },
      {
        ...
        description: "A Walk Through the Universe",
        prerequisites: null,
        credits: 10,
        parity: "both",
        type: "ofg",
      ...
      },
      {
        ...
        prerequisites:
          "(EYP1113 y IIC1102 y MAT1203) o (EYP1025 y IIC1103 y IMT2210) o (EYP1025 y IIC1103 y MAT1203)",
        credits: 10,
        parity: null,
        type: "opt",
      },
      {
        ...
        prerequisites: "IIC2142 o IIC2143",
        credits: 10,
        parity: null,
        type: "opt",
      },
      {
        ...
        description: "Software Systems Architecture",
        prerequisites: "IIC2142 o IIC2143",
        credits: 10,
        parity: null,
        type: "opt",
      },
      {
        ...
        prerequisites: "IIC2283 o IIC3222",
        credits: 10,
        parity: null,
        type: "opt",
      },
    ...
    console.log(
      `✅ Ramos listos: Se insertaron/verificaron ${coursesData.length} cursos.`,
    );
