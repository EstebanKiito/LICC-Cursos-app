...
// ==========================================
// ANOTACIONES Y SUBRAYADOS (PDFs)
// ==========================================
Material.hasMany(Annotation, {
  foreignKey: "materialId",
  as: "materialAnnotations",
  onDelete: "CASCADE",
});
Annotation.belongsTo(Material, {
  foreignKey: "materialId",
  as: "annotatedMaterial",
});

User.hasMany(Annotation, {
  foreignKey: "userId",
  as: "personalAnnotations",
  onDelete: "CASCADE",
});
Annotation.belongsTo(User, { foreignKey: "userId", as: "annotationAuthor" });

// ==========================================
// 9. CUADERNOS Y APUNTES (MARKDOWN / LATEX)
// ==========================================
User.hasMany(Notebook, {
  foreignKey: "userId",
  as: "personalNotebooks",
  onDelete: "CASCADE",
});
Notebook.belongsTo(User, { foreignKey: "userId", as: "notebookOwner" });

Course.hasMany(Notebook, {
  foreignKey: "courseId",
  as: "courseNotebooks",
  onDelete: "CASCADE",
});
Notebook.belongsTo(Course, { foreignKey: "courseId", as: "relatedCourse" });
